...
export default function SanatanProfile() {
  const achievements = [
    {
    ...
    },
    {
      ...
      description: 'Revolutionized student healthcare access and preventive care approaches'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {achievements.map((achievement, index) => (
              ...
              >
                <h3 className="text-xl font-bold mb-3 text-trust-navy dark:text-clinic-white">
                  {achievement.title}
                </h3>
